...
export const PageLoader = () => (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white">
        ...
        <div className="absolute top-0 left-0 right-0 h-1 overflow-hidden">
            <div className="h-full bg-[#117ACA] animate-progress-bar" />
        </div>
        ...
        <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex gap-1.5">
                <span className="h-2 w-2 rounded-full bg-[#117ACA] animate-bounce [animation-delay:0ms]" />
                <span className="h-2 w-2 rounded-full bg-[#117ACA] animate-bounce [animation-delay:150ms]" />
                <span className="h-2 w-2 rounded-full bg-[#117ACA] animate-bounce [animation-delay:300ms]" />
            </div>
        </div>
    </div>
);
